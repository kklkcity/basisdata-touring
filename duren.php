...
function initMap() {
  var uluru = {lat:-7.5687987, lng: 110.7185977};
  ...
  var contentString = '<div id="content">'+
      '<div id="siteNotice">'+
      '</div>'+
      '<h4 id="firstHeading" class="firstHeading">SPBU Karang Duren (Salakan)</h4>'+
      '<div id="bodyContent">'+
      '<p><b>SPBU Karang Duren (Salakan)</b></p>'+
      '</div>'+
      '</div>';
  ...
  var marker = new google.maps.Marker({
    position: uluru,
    map: map,
    title: 'SPBU Karang Duren (Salakan)'
  });
