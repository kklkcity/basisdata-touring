...
function initMap() {
  var uluru = {lat:-7.5863137, lng: 110.7097283};
  ...
  var contentString = '<div id="content">'+
      '<div id="siteNotice">'+
      '</div>'+
      '<h4 id="firstHeading" class="firstHeading">SPBU Sawit, Boyolali</h4>'+
      '<div id="bodyContent">'+
      '<p><b>SPBU Sawit, Boyolali</b></p>'+
      '</div>'+
      '</div>';
