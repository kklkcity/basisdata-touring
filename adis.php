...
function initMap() {
  var uluru = {lat:-7.7829867, lng: 110.4057443};
  ...
  var contentString = '<div id="content">'+
      '<div id="siteNotice">'+
      '</div>'+
      '<h4 id="firstHeading" class="firstHeading">SPBU Bandara Adisucipto</h4>'+
      '<div id="bodyContent">'+
      '<p><b>SPBU Bandara Adisucipto</b></p>'+
      '</div>'+
      '</div>';
